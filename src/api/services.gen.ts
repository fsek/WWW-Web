...
export class CouncilsService {
     ...
     * Exempel Namn
     */
    public static exempelNamn<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<CouncilsExempelNamnResponse, CouncilsExempelNamnError, ThrowOnError>({
            ...options,
            url: '/council/exempel'
        });
    }
