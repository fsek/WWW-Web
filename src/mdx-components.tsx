...
export function useMDXComponents(components: MDXComponents): MDXComponents {
	...
	return {
			...
			if (href?.startsWith("/") || href?.startsWith("#")) {
				return (
					<Link
						href={href}
						{...props}
						className="to-primary-light from-primary bg-gradient-to-t text-transparent bg-clip-text"
					/>
				);
			}
			// External links
		...
		h4: (props) => <CustomTitle {...props} size={1} noUnderline />, // All my homies dislike h5 and h
	};
}
