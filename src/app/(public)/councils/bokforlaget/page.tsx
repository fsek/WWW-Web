...
export default function BokforlagetPage() {
	// Nämnden
	...
	return (
		<div className="flex flex-col min-h-screen">
			<TitleBanner
				title={t("utskott:bokforlaget.self")}
			...
			<div className="flex-grow bg-white dark:bg-black p-14 gap-12 ">
				<TwoColumnLayout
					leftColumnContent={
						<>
							<CustomTitle
								text={`Om ${t("utskott:bokforlaget.self")}`}
								className="mt-4"
								size={3}
							/>
							<p className="mt-4">
								{/*Inline translated link example*/}
								<Trans i18nKey="utskott:bokforlaget.about">
									<a
					...
					rightColumnContent={
						<>
							<CustomTitle
								...
								size={3}
							/>
							<p className="mt-4">{t("utskott:bokforlaget.contact")}</p>
						</>
					}
					className=""
				/>
