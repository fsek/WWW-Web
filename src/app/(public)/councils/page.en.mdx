...
<Image src={ledningenht25} alt="The Management HT25" className="w-3/5 h-auto mt-4 rounded-lg mx-auto" />
...
<Image src={balen} alt="A gang from n24 at Alces Florentina 2025" className="w-3/5 h-auto mt-4 rounded-lg mx-auto" />
