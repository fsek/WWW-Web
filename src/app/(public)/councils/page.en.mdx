...
<Image src="/images/ledningenht25.jpg" alt="The Management HT25" className="w-3/5 mt-4 rounded-lg mx-auto" />
...
<Image src="/images/balen.jpg" alt="A gang from n24 at Alces Florentina 2025" className="w-3/5 mt-4 rounded-lg mx-auto" />
