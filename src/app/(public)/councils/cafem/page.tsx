...
export default function CafemPage() {
	// Nämnden
			...
			<div className="flex-grow bg-white dark:bg-black p-14 gap-12 ">
				<TwoColumnLayout
					leftColumnContent={
						<>
							<CustomTitle
								text={`Om ${t("utskott:cafem.self")}`}
								className="mt-4"
								size={3}
							/>
							<p className="mt-4">
								{/*Inline translated link example*/}
								<Trans i18nKey="utskott:cafem.about">
									<a
					...
					rightColumnContent={
						<>
							<CustomTitle
								...
								size={3}
							/>
							<p className="mt-4">{t("utskott:cafem.contact")}</p>
							<p className="mt-4">{t("utskott:cafem.contact2")}</p>
						</>
					}
					className=""
				/>
					...
					leftColumnContent={
						<div className="">
							<CustomTitle
								...
								className="mt-4"
							/>
							<p className="mt-4"> {t("utskott:cafem.post_besk")}</p>
						</div>
					}
					rightColumnContent={
						<>
