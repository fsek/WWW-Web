...
*How exciting that you want to get involved in the most fun event of the year, the Introduction 2026!
...
Here is the presentation from the english info meeting: <a href="https://docs.google.com/presentation/d/1yAyv9kQ7qWRb_yKVeUWf2bEv_eJzU5UZ7UmlmPNY9Po/edit?slide=id.g3bfda619911_0_0#slide=id.g3bfda619911_0_0"><Button>infomöte26 SVE</Button></a>
...
*Below is a list of missions that have been included in previous Introductions, but exactly which missions are included varies from year to year:*
 ...
 - **Nollepub:** A new assignment where the group get to practice running a pub for the other mission groups. (For this reason, we don't yet know where this will fit into the schedule.)
...
*What are the Extrafös and what do they mean?*
 ...
 - **Fashionfös**: They help the Introduction Committee to sew cloaks. Fashionfös also helps with accessories and details on the Introduction Committee's outfits. You will work on this in the spring. It takes a while to sew a cloak, so it's good if you keep that in mind.
 ...
 - **Mediafös:** A new group of extrafös who will take on the responsibilities previously held by the film team and aftermovie team. The ambition is to create a group consisting of subgroups with areas of responsibility such as film script writing (theme release film and intro film), film during introduction events (aftermovie), and composing music for use during introduction, etc. This will involve tasks spread throughout the year that are divided within the group. 
 - **<span className="inline-flex text-forange" title="Coolest of them all">Webbfös</span>**: As a Webbfös, you help the Introduction Committee with everything that has to do with the fappen and the website. You work both in the spring to change the design/features of the fapp, but also during the Introduction if things go wrong with the fapp or the web. We have set a requirement that you are/have been spider- or superman.
...
*Spring*: graphics-, media-, fashion- and webbfös.

*Summer/August and Lv 0*: fashion-, colour-, graphics-, media- and campfös.

*Introduction*: Falukorv-, hot dog-, web-, media-, sitting- and hatfös.
...
*If you have any questions, just send an email to foset@fsektionen.se and we will be happy to answer!*

*XOXO,*

*the Introduction Committee 2026!*