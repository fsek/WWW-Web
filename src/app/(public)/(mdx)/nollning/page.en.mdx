...
# What is the F-guild?
The programs at Lund University are divided into different faculties. As an engineering student, you belong to the Faculty of Engineering, LTH.
...
The introduction takes place during your first five weeks as a student at the F-guild and begins for international students on Thursday, August 20. Traditionally, there is a new theme each year, and this year's theme is an Introduction on a New Level.
...
The guild’s and the Teknologkårens introduction is fully supported by LTH, but it is of course completely voluntary. You choose which events you want to participate in, but be sure to take advantage of the opportunity! Tough studies require support from those around you, and the introduction gives you a chance to find your footing in this exciting new phase of life!
...
Some days consist of several activities, and then you can of course skip one event to participate in another later. The introduction can be intense, and you participate to the extent that you want to. Rest is really important, so make sure you give yourself some too! But remember that many events require advance registration.
...
## Alcohol culture
Alcohol is present at some events during the introduction, but drinking alcohol is always voluntary. The selection of events is very diverse, and there are even completely alcohol-free events. At the F-guild, we have strong policies against all types of harassment, including alcohol harassment.
...
You will use your student account daily, and it gives you access to all computer-related services from the university. You should have received an email about this a few days after your second admission notification. Save your login details for this account so you can remember it for later!
...
It's the easiest way to keep track of your schedule, events, and everything guild-related, both during and after the introduction. You can find it where apps are available, search for F-sektionen or click on the correct link down below.

<Link href="https://play.google.com/store/apps/details?id=se.fsektionen.fapp2prod">
<Image
  src="/images/app_badges/googleplay_badge_en.svg"
  alt="Google Play"
  width={155}
  height={60}
...
<Image
  src="/images/app_badges/appstore_badge_en.svg"
  alt="App Store"
  width={155}
  height={60}
  className="w-1/3 h-auto"
...
It would be a shame if your new student card, which arrives in the mail, ended up at the wrong address. You can change your address on skatteverkets website.
