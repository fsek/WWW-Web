...
export const Nollning = () => {
	...
	return (
		<section className="container grid lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10">
			...
			<div className="text-center lg:text-start space-y-6 transform transition-all duration-700 hover:translate-y-[-10px]">
				<div className="text-5xl md:text-6xl font-bold flex flex-wrap items-start gap-2 flex-col justify-start">
					<div className="inline to-primary/70 from-primary bg-gradient-to-t text-transparent bg-clip-text transform transition-all duration-500 hover:scale-105 hover:rotate-1 cursor-default">
						{t("nollning.title")}
					</div>
				</div>
